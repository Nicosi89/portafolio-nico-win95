...
//lista de trabajos
export const dataTarjetasTrabajos: TarjetaTrabajo[] = [
    {
        id: 'portafolio',
        tipo: 'app-web',
        ...
        content:
            <Content title="Prueba2" imgAlt="Podcaster App" imgsUrl={[
    ...
    },
    {
        ...
        imagenes: [
            './imagenes-trabajos/podcastr.jpeg'
        ],
    ...
    },
    {
        ...
        content: <Content
            title="Prueba"
            imgAlt="Prueba"
            imgsUrl={['/imagenes-trabajos/ahora-fandi.png', '/imagenes-trabajos/ahoraF&I-3.png.jpg', '/imagenes-trabajos/ahora-antes-mobile-f&I.jpg', '/imagenes-trabajos/ahora-antes-pc-f&I.jpg']} />,
        imagenes: [
            '/imagenes-trabajos/ahora-fandi.png',
            '/imagenes-trabajos/ahoraF&I-3.png.jpg',
            '/imagenes-trabajos/ahora-antes-mobile-f&I.jpg',
            '/imagenes-trabajos/ahora-antes-pc-f&I.jpg'
        ],
    ...
    },
    {
        ...
        content: <Content
            title="Prueba2"
            imgAlt="Prueba2"
            imgsUrl={['/imagenes-trabajos/retarte-pc.jpeg', '/imagenes-trabajos/retarte-todo-pc.jpg', 'imagenes-trabajos/app-retarte.jpg']} />,
        imagenes: [
            '/imagenes-trabajos/retarte-pc.jpeg',
            '/imagenes-trabajos/retarte-todo-pc.jpg',
            'imagenes-trabajos/app-retarte.jpg'
        ],
    ...
    },
    {
        ...
        imagenes: [
            '/imagenes-trabajos/caring-data1.png',
            '/imagenes-trabajos/antes-caring-data-hero.jpg',
            '/imagenes-trabajos/completo-caring-data.jpg',
            '/imagenes-trabajos/antes-pc-caring-data.jpg'
        ],
        tecnologias: ['Wix']
    ...
    },
    {
        ...
        imagenes: [
            '/imagenes-trabajos/boltapps1.jpg', '/imagenes-trabajos/boltapps-2.jpg', '/imagenes-trabajos/boltapps-3.jpg'
        ],
        tecnologias: ['Wix']
...

    {
        ...
        imagenes: [
            '/imagenes-trabajos/home-amazoniko.jpg', '/imagenes-trabajos/mobile-amazoniko.jpg', '/imagenes-trabajos/diseño-amazoniko.jpg'
        ],
    ...
    },
    {
        ...
        imagenes: [
            '/imagenes-trabajos/herbivoro-1.jpg', '/imagenes-trabajos/herbivoro-2.jpg', 'imagenes-trabajos/herbivoro-3.jpg'
        ],
        tecnologias: ['Glide Apps']
